...
public class UserInterface implements Observer{	
	...
	public UserInterface() { 
		...
		instructions.append("To change rooms: move + up/down/left/right \n");
		...
		instructions.append("To talk to a character: talk to + name \n");
		instructions.append("To get a description: describe + room/character/item + name \n");
		instructions.append("To drop an item: drop + item name");
		
		outBox.setText("Welcome to Goucher! We hope you enjoy exploring Julia Rogers and Van Meter. When you're done exploring, please type exit.");
